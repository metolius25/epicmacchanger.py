...
def get_Input():
    parser = agp.ArgumentParser(
                    ...
                    description='Simple Python app to specify a new MAC address. Likely not going to work on virtual machines. Restart your PC if it kills your internet connection.',
                    epilog='Example usage: python3 epicmacchanger.py -i eth0 -m 00:H1:E2:L3:L4:O5 (Hexadecimal characters only)')
...
def control_Mac(iface):
    ...
    ip_addr = subprocess.check_output(["sudo", "ifconfig", iface])
...
if final_mac.lower() == args.mac_address.lower():
